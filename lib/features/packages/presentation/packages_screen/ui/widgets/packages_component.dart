import 'package:eltakamel/features/billing/presentation/billing_screen/ui/widgets/empty_table_widget.dart';
import 'package:eltakamel/features/packages/presentation/packages_screen/logic/packages_state.dart'
    show PackagesState, PackagesLoading, PackagesError, PackagesLoaded, PackagesEmpty;
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<PackagesCubit, PackagesState>(
        builder: (context, state) {
          ...
          } else if (state is PackagesEmpty) {
            return Center(
