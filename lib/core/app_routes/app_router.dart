...
import '../../features/profile/presentation/profile_screen/ui/widgets/profile_body.dart' show ProfileBody;


class AppRouter {
  static List<GoRoute> get generateRoute {
    return [
      GoRoute(path: Routes.homeScreen, builder: (context, state) => const HomeScreen()),
      GoRoute(path: Routes.profileScreen, builder: (context, state) => const ProfileBody()),
    ];
  }
}
