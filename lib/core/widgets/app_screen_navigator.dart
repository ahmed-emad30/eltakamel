...
import 'package:flutter/material.dart' show BuildContext, Colors, StatelessWidget, Widget;
...
import '../../features/shared/presentation/shared_screen/logic/shared_cubit.dart' show SharedCubit, SharedState;
...
class AppScreenNavigator extends StatelessWidget {
  const AppScreenNavigator({super.key,  required this.path, required this.sliver,  this.hasList=false, });
final String? path;
final Widget sliver;
final bool hasList;
  @override
